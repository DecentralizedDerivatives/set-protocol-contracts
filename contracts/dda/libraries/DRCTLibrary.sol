...
library DRCTLibrary{
    ...
    *@return total supply
    */
    function totalSupply(TokenStorage storage self) public view returns (uint _total_supply) {
    ...
    */
    function addressCount(TokenStorage storage self, address _swap) public view returns (uint) { 
    ...
    */
    function getBalanceAndHolderByIndex(TokenStorage storage self, uint _ind, address _swap) public view returns (uint, address) {
    ...
    */
    function getIndexByAddress(TokenStorage storage self, address _owner, address _swap) public view returns (uint) {
    ...
    */
    function allowance(TokenStorage storage self, address _owner, address _spender) public view returns (uint) {
