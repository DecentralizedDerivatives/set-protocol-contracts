...
contract Exchange{ 
    ...
    */
    function getOrderCount(address _token) public view returns(uint) {
    ...
    */
    function getOrders(address _token) public view returns(uint[]) {
    ...
    */
    function getUserOrders(address _user) public view returns(uint[]) {
