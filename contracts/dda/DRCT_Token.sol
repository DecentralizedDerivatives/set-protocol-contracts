...
contract DRCT_Token {
    ...
    */
    function addressCount(address _swap) public view returns (uint) { 
    ...
    */
    function getBalanceAndHolderByIndex(uint _ind, address _swap) public view returns (uint, address) {
    ...
    */
    function getIndexByAddress(address _owner, address _swap) public view returns (uint) {
